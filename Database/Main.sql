...
CREATE DATABASE IF NOT EXISTS `takel4` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `takel4`;
...
CREATE TABLE IF NOT EXISTS `main` (
  ...
  `Jenis Kendaraan` varchar(10) NOT NULL,
